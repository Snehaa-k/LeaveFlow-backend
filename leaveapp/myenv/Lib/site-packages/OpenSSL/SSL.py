...
class Context:
    ...
    def __init__(self, method: int) -> None:
        ...
        self._cookie_generate_helper: Optional[_CookieGenerateCallbackHelper] = None
        self._cookie_verify_helper: Optional[_CookieVerifyCallbackHelper] = None
    ...
    def set_verify(self, mode: int, callback: Optional[_VerifyCallback] = None) -> None:
        """
    ...
    def _set_ocsp_callback(
        self,
        helper: typing.Union[_OCSPClientCallbackHelper, _OCSPServerCallbackHelper],
        data: Optional[Any],
    ) -> None:
        """
